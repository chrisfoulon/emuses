...
def validate_installation():
    ...
    try:
        ...
        from emuses.utils.dependency_check import check_critical_dependencies, get_install_command
        ...
        if all_ok:
            ...
            print("   API: uvicorn emuses.api.main:create_app --factory --host 127.0.0.1 --port 8000")
