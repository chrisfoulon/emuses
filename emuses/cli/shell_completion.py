...
class ShellCompletionManager:
    ...
    def _register_default_commands(self):
        ...
        self.register_command('visualize', {
        ...
        self.register_command('interactive', {
...
'''
        ...
        # PowerShell template
        self.shell_templates['powershell'] = '''
...
class CommandCompleter:
    ...
    def complete_argument_values(self, command: str, argument: str, partial: str) -> List[str]:
        """
...
class FilePathCompleter:
    ...
    def __init__(self, base_directory: Optional[str] = None):
        ...
        None
        """
        self.allowed_extensions = ['.txt', '.csv', '.json', '.xml', '.yaml', '.yml', '.parquet']
