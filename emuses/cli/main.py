...
def full(
    ...
    columns_are_features: Annotated[bool, typer.Option(help="Columns are features in the spreadsheet input dataset")] = False,
    ...
    interactive_plot: Annotated[bool, typer.Option(help="Option to create interactive clustering plots")] = False,
    ...
    random_state: Annotated[int, typer.Option(help="Master random seed for reproducibility")] = 42,
