...
def main():
    ...
    parser.add_argument("--folder", type=str, default="output", help="Folder containing UMAP HTML files")
    parser.add_argument("--prefix", type=str, default="umap", help="Prefix for UMAP files")
